    ...
    with engine.begin() as connection:
        ...
        if "community_chat_messages" in tables:
            ...
            if "is_hidden" not in columns:
                connection.execute(text(
                    "ALTER TABLE community_chat_messages ADD COLUMN is_hidden BOOLEAN NOT NULL DEFAULT 0"
                ))
        ...
        if "community_reports" in tables:
            ...
            if "resolved_at" not in columns:
                connection.execute(text("ALTER TABLE community_reports ADD COLUMN resolved_at DATETIME"))
